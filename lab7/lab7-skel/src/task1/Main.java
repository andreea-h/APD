...
class GetPathTask implements Runnable{
    ArrayList<Integer> partialPath;
    int dest; /**nod destinatie**/
    ExecutorService tpe;

    public GetPathTask(ExecutorService tpe, ArrayList<Integer> partialPath, int dest) {
        this.tpe = tpe;
        this.dest = dest;
    ...
    public void run() {
        ...
        for (int[] ints : Main.graph) {
            if (ints[0] == lastNodeInPath) {
                ...
                tpe.submit(new GetPathTask(tpe, newPartialPath, dest));
            }
        }
    }
}
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tpe.submit(new GetPathTask(tpe, partialPath, 3));
    }
}
